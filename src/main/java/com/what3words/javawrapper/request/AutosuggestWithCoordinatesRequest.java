...
public class AutosuggestWithCoordinatesRequest extends Request<AutosuggestWithCoordinates> {
    ...
    private AutosuggestWithCoordinates execute() {
        return super.execute(api.what3words().autosuggestWithCoordinates(input, nResults, focus, nFocusResults, clipToCountry, clipToBoundingBox, clipToCircle, clipToPolygon, inputType, language, preferLand), AutosuggestWithCoordinates.class);
    }
